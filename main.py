...
choice1= input('You\'re at a cross road. whare do you want to go? Type "left" or "right"\n ').lower()
#low_road= Firoad.lower()
if choice1 == "left":
  ...
  if choice2 == "wait":
    choice3= input("You arrive at the Island unharmed. There is a house with 3 doors,one red,one yellow and one blue.Whitch coluor do you choose?\n").lower()
     #waitl= wait.lower() 
    if choice3 =="yellow":
